...
namespace Spring12BiuBiuBiu
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("[OK] 硬件系统自检完成...\n");
            Thread.Sleep(1000);
            Console.WriteLine("[OK] 撞针系统自检完成...\n");
            Thread.Sleep(1000);
            Console.WriteLine("[OK] 行星转向发动机正在启动中！启动进度：\n");
